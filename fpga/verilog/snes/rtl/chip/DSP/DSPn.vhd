...
begin
	...
	PROG_ROM : entity work.dspn_prog_rom -- Game Bub: generated from ROM dumps, see tools/gen_roms.py
	port map(
		clock		=> CLK,
	...
	DATA_ROM : entity work.dspn_data_rom -- Game Bub: generated from ROM dumps, see tools/gen_roms.py
	port map(
		clock		=> CLK,
	...
	DATA_RAM_ADDR_B <= SS_RAM_A(11 downto 1) when SS_BUSY = '1' else
						...
						DATA_RAM_ADDR_A or ("000" & x"40"); -- Game Bub: explicit width (Vivado)
